...
namespace Stock.Lib
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        */
        ...
        public static Vector2 checkCrossPoint( Vector2 p1, Vector2 p2, Vector2 q1, Vector2 q2)
        {
            ...
            var paramDenominator = x43 * y21 - x21 * y43;

            //No intersection
            if (paramDenominator == 0)
                return Vector2.Zero;

            var s = (x43 * y31 - x31 * y43) / paramDenominator;
            var t = (x21 * y31 - x31 * y21) / paramDenominator;
            ...
            //Intersection at but is not on the lines.
            else
            {
                return Vector2.Zero;
            }
